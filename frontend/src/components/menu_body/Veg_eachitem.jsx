...
export default function Veg_eachitem() {
  ...
  if (Item.length === 0) {
    return <div>No veg items found.</div>;
  }
  ...
  return (
    <>
      ...
      <div className="flex flex-wrap items-center max-[300px]:justify-between w-full mb-6 mx-3 sm:mx-0 max-[300px]:flex-col">
        {currentItems.map((item) => (
          ...
          sm:w-[30vw] md:w-[22vw] lg:w-[15vw] max-[320px]:w-[41vw] max-[300px]:w-[65vw] mr-3 sm:mr-8 md:mr-6 lg:mr-4"
          >
